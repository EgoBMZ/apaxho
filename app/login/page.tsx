    ...
    <div className="min-h-screen bg-[#f1f1f4] text-[#1c1c24] flex flex-col font-mono selection:bg-[#1c0dcb] selection:text-white relative items-center justify-center p-6 overflow-hidden">
      ...
      >
        ...
        <div className="text-center flex flex-col gap-2">
          ...
          <h1 className="font-doodle text-xl font-bold text-[#1c0dcb]">{t("authLoginTitle")}</h1>
          <p className="text-xs text-[#1c1c24]/60 max-w-xs mx-auto leading-relaxed">{t("authLoginSubtitle")}</p>
        </div>
        ...
        <p className="text-center text-xs text-[#1c1c24]/55 mt-2">
          {t("authNoAccount")}{" "}
          <Link href="/registro" className="text-[#1c0dcb] font-bold hover:underline">
            {t("authBtnRegister")}
          </Link>
        </p>
      </motion.div>
